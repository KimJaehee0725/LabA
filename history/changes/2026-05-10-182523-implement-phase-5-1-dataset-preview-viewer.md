# Change - Implement Phase 5.1 dataset preview viewer
...
HF-like UI에서 dataset 파일을 다운로드 전에 샘플 기반으로 확인할 수 있어야 해서 json/jsonl/csv preview를 추가했다.

## How

FastAPI preview endpoint, bounded parsers, sample stats, static UI selector/panels, seed sample splits, smoke checks를 추가했다. Parquet와 full-file scan은 제외했다.
...
- docker build -t lab/hf-ui:phase5-preview-check deploy/hf-ui/app
- docker run preview helper assertions for jsonl/csv/json stats
